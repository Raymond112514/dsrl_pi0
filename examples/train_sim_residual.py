...
from examples.train_utils_sim_residual import trajwise_alternating_training_loop
...
class DummyEnv(gym.ObservationWrapper):
    ...
    def __init__(self, variant):
        ...
        # Add diffusion_action to observation space for residual RL
        # Infer action_horizon and action_dim from variant or use defaults
        query_freq = variant.query_freq if variant.query_freq > 0 else 20
        if variant.env == 'libero':
